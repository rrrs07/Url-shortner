...
const LinkPage = () => {
  ...
  console.log("Stats in LinkPage:", stats);

  // --- CUSTOM URL LOGIC ---
  let link = "";
  if (url) {
    // Try all possible property names for custom url
  ...
  const statsValid =
    ...
    ("device" in stats[0] || "city" in stats[0]);
            ...
            <CardContent className="flex flex-col gap-6">
              {!statsValid && (
                <div className="text-red-500">
                  Warning: Stats data missing <b>device</b> or <b>city</b> fields.
                </div>
              )}
